...
export function StaffAuthProvider({ children }) {
    ...
    const login = async (email, password) => {
        ...
        // Prevent normal platform admins from logging into the Staff Portal
        if (decoded.role === 'admin' && !decoded.is_superuser) {
            throw new Error('Platform admins must use their respective portals. This portal is for super admins and staff only.');
        }
